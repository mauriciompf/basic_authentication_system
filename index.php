...
<body>
    <div class="wrapper">
        <main class="main">
            ...
            <div class="wrapper-form_register wrapper-form_login active">
                <h2 class="heading">Sign-up</h2>
                <form action="index.php" method="POST" class="form">
                    <div class="input">
                        <label for="f_name">First Name*</label>
                        <input type="text" name="fname" id="f_name" aria-label="First Name" required>
                    </div>
                    <div class="input">
                    ...
                    <div class="input">
                        ...
                        <input type="email" name="r_email" id="r_email" aria-label="Email" required>
                    </div>
                    <div class="input">
                        <label for="r_password">Password*</label>
                        <input type="password" name="r_password" id="r_password" aria-label="Password" required>
                    </div>
                    <div class="input">
                        <label for="confirm_pass">Confirm Password*</label>
                        <input type="password" name="confirm_pass" id="confirm_pass" aria-label="Confirm Password" required>
                    </div>
                    <div class="form_buttons">
                        <button type="submit" class="btn btn-enter" aria-describedby="Enter with your account">Enter</button>
